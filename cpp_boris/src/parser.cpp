...
Statement Parser::func()
{
    ...
    this->root.globals[std::get<Function>(func_statement.value).name] = func_statement;

    return func_statement;
}

std::vector<Statement> Parser::func_parameters(LineIterator& func_it)
{
    ...
    do
    {
        ...
        Statement param_statement = Statement{};
        param_statement.type = StatementType::VARIABLE;
